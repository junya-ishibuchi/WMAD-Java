...
public class MyLinkedList<E> {
    ...
    public boolean remove(E e) {
        final Node<E> removeNode = new Node<>(e, null);
        Node<E> cur = head;
        for (int i = 0; i < size; i++) {
            if (cur.data.equals(removeNode.data)) {
    ...
    public int lastIndexOf(E e) {
        final Node<E> searchNode = new Node<>(e, null);
        Node<E> cur = head;
        int index = -1;
        for (int i = 0; i < size; i++) {
            if (cur.data.equals(searchNode.data)) {
                index = i;
                break;
            }
            cur = cur.next;
